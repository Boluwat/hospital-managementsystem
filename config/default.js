module.exports = {
  swagger: {
    active: true,
    host: "api.dev.hms.com",
  },
  environment: process.env.ENVIRONMENT || 'Staging',
  mongodb: {
    url:
      process.env.DB_HOST ||
      "mongodb+srv://Boluwatife:Oyedemi14@cluster0.seu4p.mongodb.net/healthManagementSystem?retryWrites=true&w=majority",
  },
  jwtSecret: process.env.JWT_SECRET || "boluwatife_peter_oyedemi",
  superAdminPassword: process.env.SUPERADMINPASSWORD || 1234,
  migrationIDS: {
    HOSPITAL_ADMIN_ID:
      process.env.HOSPITAL_ADMIN_ID || "62d6a89e1caa4942b1db3fb8",
